  ...
  return (
    <div style={{ marginTop: '2em' }}>
      <div className="jumbotron text-center">
        <h1>SignLang - ASL Translator</h1>
        <h4>
          SignLang uses machine learning to transform webcam input into readable
          sign language using a variety of different techniques. The series of
          texts below detail the steps taken for SignLang to translate an image
          into a final word.
        </h4>
      </div>
